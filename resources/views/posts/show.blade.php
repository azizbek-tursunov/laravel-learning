            ...
            <div class="row">
                ...
                <div class="mb-5">
                    <div class="d-flex mb-2">
                        ...
                        @endforeach
                        <a
                            class="text-secondary text-uppercase font-weight-medium">{{ $post->created_at->format('H:i d.M.Y') }}</a>
                    </div>
                    <a
                ...
                <div class="mb-5">
                    <h3 class="mb-4 section-title">{{ $post->comments()->count() }} ta fikrlar</h3>
                    @foreach ($post->comments as $comment)
                        <div class="media mb-4">
                            <img src="/img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1"
                                style="width: 45px;">
                            <div class="media-body">
                                <h6>{{ $comment->user->name }}<small><i>
                                            {{ $comment->created_at->format('d M Y H:i') }}</i></small></h6>
                                <p>{{ $comment->body }}</p>
                ...
                <div class="bg-light rounded p-5">
                    <h3 class="mb-4 section-title">Fikrlar</h3>
                    {{--                            <div class="form-row"> --}}
                    ...
                    <form action="{{ route('comments.store') }}" method="POST">
                        ...
                        <div class="form-group mb-0">
                            <input type="submit" value="Fikr bildirish" class="btn btn-primary">
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="mb-5">
                    ...
                    <ul class="list-inline m-0">
                        <li class="mb-1 py-2 px-3 bg-light d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge badge-primary badge-pill">150
                            </span>
                        </li>
                        <li class="mb-1 py-2 px-3 bg-light d-flex justify-content-between align-items-center">
                            <a class="text-dark" href="#"><i
