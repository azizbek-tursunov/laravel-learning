                    ...
                    <div class="panel-body p-3">
                        <form action="{{ route('register.store') }}" method="POST">
                            ...
                            <div class="form-group py-2">
                                <div class="input-field"> <span class="far fa-user p-2"></span> <input name="name" type="text"
                            ...
                            <div class="form-inline"> <input type="checkbox" name="remember" id="remember"> <label
                                    for="remember" class="text-muted">Meni eslab qol</label> <a href="#"
                            ...
                            <div class="text-center pt-4 text-muted">Akkauntingiz bormi? <a href="{{ route('login') }}">Kirish</a> </div>
                        </form>
                    </div>
